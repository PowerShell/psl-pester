...
'@
    ...
    Describe 'Stripping common parent paths' {
        $paths = @(
            '/Common/Folder/UniqueSubfolder1/File.ps1'
            '/Common/Folder/UniqueSubfolder2/File2.ps1'
            '/Common/Folder/UniqueSubfolder3/File3.ps1'
        )

        $commonPath = Get-CommonParentPath -Path $paths

        It 'Identifies the correct parent path' {
            $commonPath | Should Be '/Common/Folder'
        }
