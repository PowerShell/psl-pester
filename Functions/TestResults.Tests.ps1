...
InModuleScope Pester {
    Describe "Write nunit test results (Legacy)" {
        ...
        It "should write a successful test result" {
            ...
            $testFile = "$TestDrive${directorySeparatorChar}Results${directorySeparatorChar}Tests.xml"
        ...
        It "should write a failed test result" {
            ...
            $xmlTestCase.failure.'stack-trace'  | Should Be 'at line: 28 in  C:${directorySeparatorChar}Pester${directorySeparatorChar}Result.Tests.ps1'
        }
        ...
        Context 'Exporting Parameterized Tests (New Legacy)' {
            ...
            $TestResults.AddTestResult(
                ...
                'at line: 28 in  C:${directorySeparatorChar}Pester${directorySeparatorChar}Result.Tests.ps1',
                'Parameterized Testcase <A>',
                @{ Parameter = 'Two' }
    ...
    Describe "GetFullPath" {
        It "Resolves non existing path correctly" {
            pushd TestDrive:${directorySeparatorChar}
